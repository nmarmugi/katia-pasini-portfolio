...
export default function About() {
	...
	return (
		<div id="about" className="pt-[110px] pb-10 md:pb-20 bg-glideBackground px-5 flex justify-center items-center">
			<div className="w-full max-w-[1440px] flex justify-between items-center md:px-10">
				<div className="flex flex-col items-center gap-4 w-full">
					<div className="flex items-center gap-5">
						<div className="flex flex-col items-center gap-1 md:gap-2">
							...
							<div className="flex gap-2 items-end">
								<h2 className="font-inter text-text font-semibold text-3xl md:text-[40px]">
									Ciao
								</h2>
								<div className="flex justify-end md:w-28 md:h-12 w-20 h-10 rounded-full bg-fourthBackground p-[2px]">
					...
					<h3 className="font-inter text-center text-text font-light md:text-2xl">
					...
					<h3 className="font-inter text-text text-center  font-light md:text-2xl">
						...
						{contentCards.map((card) => (
							<div key={card.number} className="w-full lg:w-1/3">
								<Card bg={'fourthBackground'}>
									<h4 className="font-inter text-secondBackground font-bold text-3xl">
										{card.number}
									</h4>
									<h4 className="font-inter text-secondBackground italic font-light text-xl text-center">
										{card.label}
									</h4>
								</Card>
							</div>
