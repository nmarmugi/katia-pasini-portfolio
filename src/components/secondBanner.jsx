		...
		<div className="bg-thirdBackground px-5 py-10 flex justify-center items-center">
			<div className="w-full max-w-[1440px] flex flex-col md:flex-row justify-center items-center md:px-10 gap-8">
				<div className="flex justify-center md:justify-start w-full md:w-1/2">
					<img src="/secondBanner.png" alt='Image second banner' />
				</div>
				<div className="flex flex-col md:items-end gap-5 w-full md:w-1/2">
					<h2 className="font-inter text-2xl text-text font-semibold md:text-end">
						Creo design che funzionano, non solo che piacciono.
					</h2>
					<p className="font-inter text-lg text-text md:text-end">
					...
					<div className="md:max-w-[510px] mt-4 w-full flex justify-center">
						<Card>
							<h2 className="font-inter text-lg text-text font-semibold text-center">
								Mi aggiorno costantemente su
							</h2>
							<div className="flex justify-center flex-wrap gap-2">
								{
									updates.map((update =>
									<span key={update.id} className="font-inter font-light text-text text-xs p-1 border border-text rounded-2xl">
										{update.label}
									</span>))
								}
							</div>
