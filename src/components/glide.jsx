...
export default function Glide() {
	...
	return (
		<div id="projects" className="bg-blueGradientOrizontal px-5 py-10 flex justify-center items-center">
			<div className="w-full max-w-[1440px] flex flex-col justify-center items-center md:px-10 gap-10">
				<div className="flex flex-col md:gap-6">
					<h2 className="font-inter text-testBackground font-semibold text-2xl text-center md:text-[40px]">
						I miei progetti
					</h2>
					<p className="font-inter text-testBackground text-lg text-center md:text-[26px]">
								...
								glide.map((gli => 
									<div key={gli.id} className="glide__slide flex flex-col md:flex-row justify-center items-center gap-5">
										<div className="w-full md:w-1/3 lg:w-1/2">
											<img className="rounded-2xl" src={gli.src} alt="Image Projects" />
										</div>
										<div className="flex flex-col items-center md:items-start gap-4 w-full md:w-2/3 lg:w-1/2">
											<div className="text-center md:text-start">
												<h3 className="font-inter text-testBackground text-lg md:text-3xl font-semibold md:mb-2">
													{gli.title}
												</h3>
												<p className="font-inter text-testBackground md:text-[22px]">
													{gli.paragraph}
												</p>
											</div>
