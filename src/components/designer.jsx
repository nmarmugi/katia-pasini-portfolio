		...
		<div className="bg-blueGradientOrizontal px-5 py-10 flex justify-center items-center">
			<div className="w-full max-w-[1440px] flex flex-col justify-center items-center md:px-10 gap-10 md:gap-20">
				<div className="flex flex-col gap-3 w-full">
					<h2 className="font-inter text-testBackground font-semibold text-2xl text-center md:text-[40px] md:mb-4">
						Dietro la Designer
					</h2>
					<p className="font-inter text-testBackground text-lg text-center md:text-[26px]">
						Ogni grande designer ha un team. Il mio include <span className="font-bold">Brando,</span>
					</p>
					<p className="font-inter text-testBackground text-lg text-center md:text-[26px]">
						...
						>
							<Card bg={"testBackground"}>
								...
								<div className="flex justify-start w-full lg:mb-5">
									<p className="font-inter text-p text-sm md:text-[22px] md:leading-[1.2]">
								...
								<div className="flex justify-start w-full p-2 bg-text2 rounded-md">
									<p className="font-inter text-testBackground text-sm font-light italic md:text-lg">
